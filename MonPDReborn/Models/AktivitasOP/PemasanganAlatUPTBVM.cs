        ...
        public class Method
        {
            ...
            public static List<DataPemasanganAlat> GetTahunBerjalan(int wilayah)
            {
                ...
                var dbopResto = context.DbOpRestos
                    .Where(x => x.TahunBuku == tahunSekarang && (x.TglOpTutup.HasValue == false || x.TglOpTutup.Value.Year > tahunSekarang) && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayah.ToString())
                    .GroupBy(x => 1)
                    .Select(g => new
                    {
                ...
                var dbopHotel = context.DbOpHotels
                    .Where(x => x.TahunBuku == tahunSekarang && (x.TglOpTutup.HasValue == false || x.TglOpTutup.Value.Year > tahunSekarang) && x.WilayahPajak == wilayah.ToString())
                    .GroupBy(x => 3)
                    .Select(g => new
                    {
            ...
            public static List<DetailDataPemasanganAlat> GetDetailTahunBerjalan(EnumFactory.EPajak jenisPajak, int wilayah)
            {
                ...
                var dbopResto = context.DbOpRestos
                     .Where(x => x.TahunBuku == tahunSekarang
                              ...
                              && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayah.ToString())
                ...
                var dbopHotel = context.DbOpHotels
                    .Where(x => x.TahunBuku == tahunSekarang
                             && (!x.TglOpTutup.HasValue || x.TglOpTutup.Value.Year > tahunSekarang && x.WilayahPajak == wilayah.ToString()))
