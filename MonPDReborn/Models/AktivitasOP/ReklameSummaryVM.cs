            ...
            public static List<ReklamePermanen> GetReklamePermanen(int tahun)
            {
                ...
                for (int i = 1; i <= 12; i++)
                {
                    ...
                    ret.Add(new ReklamePermanen()
                    {
                        ...
                        SKPDPanjang = dataPer.Where(x => x.IdFlagPermohonan == 2 && x.Tahun == tahun && x.Bulan == i && x.IsPerpanjangan == 1).Count(),
                        NilaiPanjang = dataPer.Where(x => x.IdFlagPermohonan == 2 && x.Tahun == tahun && x.Bulan == i && x.IsPerpanjangan == 1).Sum(x => x.PajakPokok) ?? 0,
            ...
            public static List<TerbatasReklame> GetTerbatasReklame(int tahun)
            {
                ...
                for (int i = 1; i <= 12; i++)
                {
                    ret.Add(new TerbatasReklame()
                    {
                        ...
                        SKPDPanjang = dataTer.Where(x => x.IdFlagPermohonan == 3 && x.Tahun == tahun && x.Bulan == i && x.IsPerpanjangan == 1).Count(),
                        NilaiPanjang = dataTer.Where(x => x.IdFlagPermohonan == 3 && x.Tahun == tahun && x.Bulan == i && x.IsPerpanjangan == 1).Sum(x => x.PajakPokok) ?? 0,
                        ...
                        SKPDPanjangKB = dataTer.Where(x => x.IdFlagPermohonanA == 2 && x.TahunA == tahun && x.BulanA == i && x.TglBayarPokokA.HasValue).Count(),
                        NilaiPanjangKB = dataTer.Where(x => x.IdFlagPermohonanA == 2 && x.TahunA == tahun && x.BulanA == i && x.TglBayarPokokA.HasValue).Sum(x => x.PajakPokokA) ?? 0,
