...
namespace MonPDReborn.Models.CCTVParkir
{
    public class MonitoringCCTVVM
    {
        ...
        public class Detail
        {
            ...
            public Detail(int uptb)
            {
                MonitoringCCTVDetList = Method.GetMonitoringCCTVDetList(uptb);
            }
        }
        public class Kapasitas
        {
            public MonitoringCCTVKapasitas MonitoringCCTVKapasitasList { get; set; } = new();
        ...
        {
            new MonitoringCCTV { Nop = "NOP001", NamaOp = "Parkir Plaza Surabaya", AlamatOp = "Jl. Pemuda No. 1", WilayahPajak = "Genteng", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now.AddMinutes(-5) },
            new MonitoringCCTV { Nop = "NOP002", NamaOp = "Parkir Tunjungan Plaza", AlamatOp = "Jl. Basuki Rahmat No. 8", WilayahPajak = "Tegalsari", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now.AddMinutes(-10) },
            new MonitoringCCTV { Nop = "NOP003", NamaOp = "Parkir Galaxy Mall", AlamatOp = "Jl. Dharmahusada Indah Timur", WilayahPajak = "Mulyorejo", UptbId = uptbId, StatusAktif = "Non-Aktif", TglTerakhirAktif = DateTime.Now.AddHours(-2) },
            new MonitoringCCTV { Nop = "NOP004", NamaOp = "Parkir Royal Plaza", AlamatOp = "Jl. Ahmad Yani No. 16", WilayahPajak = "Wonokromo", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now },
            new MonitoringCCTV { Nop = "NOP005", NamaOp = "Parkir Pakuwon Mall", AlamatOp = "Jl. Puncak Indah Lontar", WilayahPajak = "Sambikerep", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now.AddMinutes(-30) },
            new MonitoringCCTV { Nop = "NOP006", NamaOp = "Parkir City of Tomorrow", AlamatOp = "Jl. Ahmad Yani No. 288", WilayahPajak = "Jambangan", UptbId = uptbId, StatusAktif = "Non-Aktif", TglTerakhirAktif = DateTime.Now.AddHours(-1) },
            new MonitoringCCTV { Nop = "NOP007", NamaOp = "Parkir Lenmarc", AlamatOp = "Jl. Bukit Darmo Golf", WilayahPajak = "Sukomanunggal", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now },
            new MonitoringCCTV { Nop = "NOP008", NamaOp = "Parkir BG Junction", AlamatOp = "Jl. Bubutan No. 1", WilayahPajak = "Bubutan", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now.AddMinutes(-45) },
            new MonitoringCCTV { Nop = "NOP009", NamaOp = "Parkir Ciputra World", AlamatOp = "Jl. Mayjen Sungkono No. 87", WilayahPajak = "Sawahan", UptbId = uptbId, StatusAktif = "Non-Aktif", TglTerakhirAktif = DateTime.Now.AddHours(-5) },
            new MonitoringCCTV { Nop = "NOP010", NamaOp = "Parkir Grand City", AlamatOp = "Jl. Walikota Mustajab No. 1", WilayahPajak = "Genteng", UptbId = uptbId, StatusAktif = "Aktif", TglTerakhirAktif = DateTime.Now }
        };
                return result;
            }

            public static List<MonitoringCCTVDet> GetMonitoringCCTVDetList(int uptb)
            {
                return new List<MonitoringCCTVDet>
        {
            ...
            public static MonitoringCCTVKapasitas GetMonitoringCCTVKapasitas(string nop)
            {
                var result = new MonitoringCCTVKapasitas
                {
                    Nop = "3171010001",
