...
{
    public class ProfilePotensiOPUPTBVM
    {
        public class Index
        {
        ...
        public class Method
        {
            public static Dashboard GetDashboardData(int wilayahPajak)
            {
                var context = DBClass.GetContext();
                ...
                .Join(
                    context.DbOpRestos
                        ...
                        {
                            g.Key.Nop,
                            TglMulaiBukaOp = g.Min(y => y.TglMulaiBukaOp),
                            KategoriId = g.First().KategoriId,
                            WilayahPajak = g.First().WilayahPajak
                        }),
                    pr => pr.Nop,
                    opr => opr.Nop,
                    (pr, opr) => new
                ...
                .Where(x => x.TahunBuku == tahun && x.WilayahPajak == wilayahPajak.ToString())
                .Count();
            ...
            public static List<RekapPotensi> GetRekapPotensiList(int wilayahPajak)
            {
                ...
                var dataResto1 = context.DbOpRestos
                    .Where(x => ((x.TahunBuku == DateTime.Now.Year - 2)) && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayahPajak.ToString())
                    .GroupBy(x => new { x.Nop })
                    .Select(x => new { x.Key.Nop })
                    .ToList();
                var dataPpj1 = context.DbOpListriks
                    .Where(x => ((x.TahunBuku == DateTime.Now.Year - 2)) && x.WilayahPajak == wilayahPajak.ToString())
                    .GroupBy(x => new { x.Nop })
                    .Select(x => new { x.Key.Nop })
                    .ToList();
                ...
                var dataResto2 = context.DbOpRestos
                    .Where(x => ((x.TahunBuku == DateTime.Now.Year - 1)) && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayahPajak.ToString())
                    .GroupBy(x => new { x.Nop })
                    .Select(x => new { x.Key.Nop })
                    .ToList();
                var dataPpj2 = context.DbOpListriks
                    .Where(x => ((x.TahunBuku == DateTime.Now.Year - 1)) && x.WilayahPajak == wilayahPajak.ToString())
                    .GroupBy(x => new { x.Nop, x.KategoriId })
                    .Select(x => new { x.Key.Nop })
                    .ToList();
                ...
                var dataResto3 = context.DbOpRestos
                     .Where(x => x.TahunBuku == DateTime.Now.Year && x.PajakNama != "MAMIN" &&
                                 (!x.TglOpTutup.HasValue || x.TglOpTutup.Value.Year > DateTime.Now.Year) && x.WilayahPajak == wilayahPajak.ToString())
                     .GroupBy(x => new { x.Nop })
                ...
                #region Now
                var targetRestoNow = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear && x.PajakId == (int)EnumFactory.EPajak.MakananMinuman && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetHotelNow = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear && x.PajakId == (int)EnumFactory.EPajak.JasaPerhotelan && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetHiburanNow = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear && x.PajakId == (int)EnumFactory.EPajak.JasaKesenianHiburan && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetParkirNow = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear && x.PajakId == (int)EnumFactory.EPajak.JasaParkir && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetListrikNow = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear && x.PajakId == (int)EnumFactory.EPajak.TenagaListrik && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                #region Mines1
                var targetRestoMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.MakananMinuman && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetHotelMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.JasaPerhotelan && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetHiburanMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.JasaKesenianHiburan && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetParkirMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.JasaParkir && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetListrikMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.TenagaListrik && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetReklameMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.Reklame && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetAbtMines1 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 1 && x.PajakId == (int)EnumFactory.EPajak.AirTanah && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                #region Mines2
                var targetRestoMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.MakananMinuman && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetHotelMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.JasaPerhotelan && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetHiburanMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.JasaKesenianHiburan && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetParkirMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.JasaParkir && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetListrikMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.TenagaListrik && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetReklameMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.Reklame && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
                ...
                var targetAbtMines2 = context.DbAkunTargetBulanUptbs.Where(x => x.TahunBuku == currentYear - 2 && x.PajakId == (int)EnumFactory.EPajak.AirTanah && x.Uptb == (decimal)wilayahPajak).Sum(x => x.Target);
            ...
            public static List<DetailPotensi> GetDetailPotensiList(EnumFactory.EPajak jenisPajak, int wilayahPajak)
            {
                ...
                switch (jenisPajak)
                {
                    case EnumFactory.EPajak.MakananMinuman:
                        ...
                        var dataResto2 = context.DbOpRestos
                            ...
                            .ToList();
                        var dataResto3 = context.DbOpRestos
                            .Where(x => ((x.TahunBuku == DateTime.Now.Year && (x.TglOpTutup.HasValue == false || x.TglOpTutup.Value.Year > DateTime.Now.Year))) && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayahPajak.ToString())
                        ...
                        foreach (var item in kategoriList)
                        {
                            ...
                            var targetResto1 = context.DbAkunTargetObjekRestos.Where(x => x.TahunBuku == DateTime.Now.Year - 2 && listOpResto1.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetResto2 = context.DbAkunTargetObjekRestos.Where(x => x.TahunBuku == DateTime.Now.Year - 1 && listOpResto2.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetResto3 = context.DbAkunTargetObjekRestos.Where(x => x.TahunBuku == DateTime.Now.Year && listOpResto3.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                    ...
                    case EnumFactory.EPajak.TenagaListrik:
                        ...
                        var dataListrik3 = context.DbOpListriks
                            .Where(x => ((x.TahunBuku == DateTime.Now.Year && (x.TglOpTutup.HasValue == false || x.TglOpTutup.Value.Year > DateTime.Now.Year))) && x.WilayahPajak == wilayahPajak.ToString())
                            .GroupBy(x => new { x.Nop, x.KategoriId })
                            .Select(x => new { x.Key.Nop, x.Key.KategoriId })
                            .ToList();
                        ...
                        foreach (var item in kategoriList)
                        {
                            ...
                            var targetListrik1 = context.DbAkunTargetObjekPpjs.Where(x => x.TahunBuku == DateTime.Now.Year - 2 && listOpListrik1.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetListrik2 = context.DbAkunTargetObjekPpjs.Where(x => x.TahunBuku == DateTime.Now.Year - 1 && listOpListrik2.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetListrik3 = context.DbAkunTargetObjekPpjs.Where(x => x.TahunBuku == DateTime.Now.Year && listOpListrik3.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            ...
                            var potensiPpjNext1 = context.DbPotensiPpjs.Where(x => listOpListrikAll.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 2).Sum(x => x.Hit1bulan) ?? 0;
                            var potensiPpjNext2 = context.DbPotensiPpjs.Where(x => listOpListrikAll.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 3).Sum(x => x.Hit1bulan) ?? 0;
                            var potensiPpjNext3 = context.DbPotensiPpjs.Where(x => listOpListrikAll.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 4).Sum(x => x.Hit1bulan) ?? 0;
                            var potensiPpjNext4 = context.DbPotensiPpjs.Where(x => listOpListrikAll.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 5).Sum(x => x.Hit1bulan) ?? 0;
                    ...
                    case EnumFactory.EPajak.JasaParkir:
                        ...
                        foreach (var item in kategoriList)
                        {
                            ...
                            var targetParkir1 = context.DbAkunTargetObjekParkirs.Where(x => x.TahunBuku == DateTime.Now.Year - 2 && listOpParkir1.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetParkir2 = context.DbAkunTargetObjekParkirs.Where(x => x.TahunBuku == DateTime.Now.Year - 1 && listOpParkir2.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetParkir3 = context.DbAkunTargetObjekParkirs.Where(x => x.TahunBuku == DateTime.Now.Year && listOpParkir3.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                    ...
                    case EnumFactory.EPajak.JasaKesenianHiburan:
                        ...
                        foreach (var item in kategoriList.Where(x => x.Id != 0 && x.Id != 54).ToList())
                        {
                            ...
                            if (item.Id != 64)
                            {
                                var targetHiburan1 = context.DbAkunTargetObjekHiburans.Where(x => x.TahunBuku == DateTime.Now.Year - 2 && listOpHiburan1.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                                var targetHiburan2 = context.DbAkunTargetObjekHiburans.Where(x => x.TahunBuku == DateTime.Now.Year - 1 && listOpHiburan2.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                                var targetHiburan3 = context.DbAkunTargetObjekHiburans.Where(x => x.TahunBuku == DateTime.Now.Year && listOpHiburan3.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            ...
                            {
                                var targetHiburan1 = context.DbAkunTargetObjekHiburans.Where(x => x.TahunBuku == DateTime.Now.Year - 2 && listOpHiburan1.Contains(x.Nop) && x.Insidentil == 0).Sum(q => q.TargetBulan) ?? 0;
                                var targetHiburan2 = context.DbAkunTargetObjekHiburans.Where(x => x.TahunBuku == DateTime.Now.Year - 1 && listOpHiburan2.Contains(x.Nop) && x.Insidentil == 0).Sum(q => q.TargetBulan) ?? 0;
                                var targetHiburan3 = context.DbAkunTargetObjekHiburans.Where(x => x.TahunBuku == DateTime.Now.Year && listOpHiburan3.Contains(x.Nop) && x.Insidentil == 0).Sum(q => q.TargetBulan) ?? 0;
                                re.Target1 = targetHiburan1;
                                re.Target2 = targetHiburan2;
                                re.Target3 = targetHiburan3;
                                totalPotensiHiburan = context.DbPotensiHiburans.Where(x => x.Nop == "000000000090300000" && x.TahunBuku == DateTime.Now.Year + 1).Sum(x => x.PotensiPajakTahun) ?? 0;
                    ...
                    case EnumFactory.EPajak.AirTanah:
                        ...
                        foreach (var item in kategoriList)
                        {
                            ...
                            var targetAbt1 = context.DbAkunTargetObjekAbts.Where(x => x.TahunBuku == DateTime.Now.Year - 2 && listOpAbt1.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetAbt2 = context.DbAkunTargetObjekAbts.Where(x => x.TahunBuku == DateTime.Now.Year - 1 && listOpAbt2.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            var targetAbt3 = context.DbAkunTargetObjekAbts.Where(x => x.TahunBuku == DateTime.Now.Year && listOpAbt3.Contains(x.Nop)).Sum(q => q.TargetBulan) ?? 0;
                            ...
                            var potensiAbtNext1 = context.DbPotensiAbts.Where(x => listOpAbt3.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 2).Sum(x => x.Hit1bulan) ?? 0;
                            var potensiAbtNext2 = context.DbPotensiAbts.Where(x => listOpAbt3.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 3).Sum(x => x.Hit1bulan) ?? 0;
                            var potensiAbtNext3 = context.DbPotensiAbts.Where(x => listOpAbt3.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 4).Sum(x => x.Hit1bulan) ?? 0;
                            var potensiAbtNext4 = context.DbPotensiAbts.Where(x => listOpAbt3.Contains(x.Nop) && x.TahunBuku == DateTime.Now.Year + 5).Sum(x => x.Hit1bulan) ?? 0;
            ...
            public static List<DetailPotensi> GetDetailPotensiList(EnumFactory.EPajak jenisPajak, bool turu, int wilayahPajak)
            {
                var ret = new List<DetailPotensi>();
                var context = DBClass.GetContext();
            ...
            public static List<DataPotensi> GetDataPotensiList(EnumFactory.EPajak jenisPajak, int kategori, int wilayahPajak)
            {
                ...
                switch (jenisPajak)
                {
                    ...
                    case EnumFactory.EPajak.MakananMinuman:
                        var dataResto1 = context.DbOpRestos
                            .Where(x => x.TahunBuku == DateTime.Now.Year - 2 && x.KategoriId == kategori && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayahPajak.ToString())
                            .ToList();
                        var dataResto2 = context.DbOpRestos
                            .Where(x => x.TahunBuku == DateTime.Now.Year - 1 && x.KategoriId == kategori && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayahPajak.ToString())
                            .ToList();
                        var dataResto3 = context.DbOpRestos
                            .Where(x => (x.TahunBuku == DateTime.Now.Year && (x.TglOpTutup.HasValue == false || x.TglOpTutup.Value.Year > DateTime.Now.Year)) && x.KategoriId == kategori && x.PajakNama != "MAMIN" && x.WilayahPajak == wilayahPajak.ToString())
                            .ToList();
                    ...
                    case EnumFactory.EPajak.TenagaListrik:
                        var dataListrik1 = context.DbOpListriks
                            .Where(x => x.TahunBuku == DateTime.Now.Year - 2 && x.KategoriId == kategori && x.WilayahPajak == wilayahPajak.ToString())
                            .ToList();
                        var dataListrik2 = context.DbOpListriks
                            .Where(x => x.TahunBuku == DateTime.Now.Year - 1 && x.KategoriId == kategori && x.WilayahPajak == wilayahPajak.ToString())
                            .ToList();
                        var dataListrik3 = context.DbOpListriks
                            .Where(x => (x.TahunBuku == DateTime.Now.Year && (x.TglOpTutup.HasValue == false || x.TglOpTutup.Value.Year > DateTime.Now.Year)) && x.KategoriId == kategori && x.WilayahPajak == wilayahPajak.ToString())
                            .ToList();
                    ...
                    case EnumFactory.EPajak.AirTanah:
                        ...
                        {
                            var totalPotensiAbt = context.DbPotensiAbts.Where(x => x.Nop == item.Nop && x.TahunBuku == DateTime.Now.Year + 1).Sum(q => q.Hit1bulan) ?? 0;
