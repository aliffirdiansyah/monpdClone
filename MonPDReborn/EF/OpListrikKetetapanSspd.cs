...
[Table("OP_LISTRIK_KETETAPAN_SSPD")]
public partial class OpListrikKetetapanSspd
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpListrikKetetapanSspds")]
    public virtual OpListrikKetetapan OpListrikKetetapan { get; set; } = null!;
}
