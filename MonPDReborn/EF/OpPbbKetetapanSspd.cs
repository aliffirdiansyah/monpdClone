...
[Table("OP_PBB_KETETAPAN_SSPD")]
public partial class OpPbbKetetapanSspd
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpPbbKetetapanSspds")]
    public virtual OpPbbKetetapan OpPbbKetetapan { get; set; } = null!;
}
