...
[Table("OP_HOTEL_KETETAPAN_SSPD")]
public partial class OpHotelKetetapanSspd
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpHotelKetetapanSspds")]
    public virtual OpHotelKetetapan OpHotelKetetapan { get; set; } = null!;
}
