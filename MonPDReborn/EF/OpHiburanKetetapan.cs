...
[Table("OP_HIBURAN_KETETAPAN")]
public partial class OpHiburanKetetapan
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpHiburanKetetapans")]
    ...
    [InverseProperty("OpHiburanKetetapan")]
    public virtual ICollection<OpHiburanKetetapanSspd> OpHiburanKetetapanSspds { get; set; } = new List<OpHiburanKetetapanSspd>();
}
