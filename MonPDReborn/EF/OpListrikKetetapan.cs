...
[Table("OP_LISTRIK_KETETAPAN")]
public partial class OpListrikKetetapan
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpListrikKetetapans")]
    ...
    [InverseProperty("OpListrikKetetapan")]
    public virtual ICollection<OpListrikKetetapanSspd> OpListrikKetetapanSspds { get; set; } = new List<OpListrikKetetapanSspd>();
}
