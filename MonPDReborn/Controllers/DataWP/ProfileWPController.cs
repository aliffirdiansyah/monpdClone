...
namespace MonPDReborn.Controllers.DataWP
{
    public class ProfileWPController : BaseController
    {
        ...
        private readonly ILogger<ProfileWPController> _logger;
        ...
        public ProfileWPController(ILogger<ProfileWPController> logger)
        {
        ...
        public IActionResult Show()
        {
            try
            {
                var model = new Models.DataWP.ProfileWPVM.Show();
        ...
        public IActionResult Detail(string NPWPD)
        {
            try
            {
                var model = new Models.DataWP.ProfileWPVM.Detail(NPWPD);
                return PartialView($"{URLView}_{actionName}", model);
            }
            catch (ArgumentException e)
            {
