...
{
    public class PenagihanController : BaseController
    {
        string URLView = string.Empty;

        private readonly ILogger<PenagihanController> _logger;
        ...
        public PenagihanController(ILogger<PenagihanController> logger)
        {
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                var model = new Models.AktivitasWP.PenagihanVM.Index();
