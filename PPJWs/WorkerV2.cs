            ...
            if (!isTahunSekarang)
            {
                ...
                if(result.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        newRow.Sumber = kategoriId;
                        newRow.SumberNama = kategoriNama;
                        newRow.Peruntukan = kategoriId;
                    ...
                    source = context.DbOpListriks.FirstOrDefault(x => x.Nop == nop && x.TahunBuku == tahunBuku);
                    if (source == null)
                    {
                    ...
                    else
                    {
                        ...
                        newRow.SumberNama = source.SumberNama;
