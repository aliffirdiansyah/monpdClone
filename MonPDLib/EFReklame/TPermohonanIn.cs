...
[Table("T_PERMOHONAN_INS")]
public partial class TPermohonanIn
{
    [Key]
    [Column("TAHUN_PEL")]
    [Precision(10)]
    ...
    [InverseProperty("TPermohonanIns")]
    ...
    [InverseProperty("TPermohonanIn")]
    public virtual ICollection<TPermohonanInsFoto> TPermohonanInsFotos { get; set; } = new List<TPermohonanInsFoto>();

    [InverseProperty("TPermohonanIn")]
    public virtual TPermohonanInsNilai? TPermohonanInsNilai { get; set; }

    [InverseProperty("TPermohonanIn")]
    public virtual TPermohonanInsPenelitian? TPermohonanInsPenelitian { get; set; }
}
