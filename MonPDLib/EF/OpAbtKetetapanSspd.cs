...
[Table("OP_ABT_KETETAPAN_SSPD")]
public partial class OpAbtKetetapanSspd
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpAbtKetetapanSspds")]
    public virtual OpAbtKetetapan OpAbtKetetapan { get; set; } = null!;
}
