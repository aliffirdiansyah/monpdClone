...
[Table("OP_ABT_KETETAPAN")]
public partial class OpAbtKetetapan
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [Column("VOL_PENGGUNAAN_AIR")]
    [Precision(10)]
    public int VolPenggunaanAir { get; set; }
    ...
    [InverseProperty("OpAbtKetetapans")]
    ...
    [InverseProperty("OpAbtKetetapan")]
    public virtual ICollection<OpAbtKetetapanSspd> OpAbtKetetapanSspds { get; set; } = new List<OpAbtKetetapanSspd>();
}
