...
[Table("OP_PARKIR_KETETAPAN_SSPD")]
public partial class OpParkirKetetapanSspd
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpParkirKetetapanSspds")]
    public virtual OpParkirKetetapan OpParkirKetetapan { get; set; } = null!;
}
