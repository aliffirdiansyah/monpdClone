...
[Table("OP_PARKIR_KETETAPAN")]
public partial class OpParkirKetetapan
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [ForeignKey("Nop")]
    [InverseProperty("OpParkirKetetapans")]
    public virtual OpParkir NopNavigation { get; set; } = null!;

    [InverseProperty("OpParkirKetetapan")]
    public virtual ICollection<OpParkirKetetapanSspd> OpParkirKetetapanSspds { get; set; } = new List<OpParkirKetetapanSspd>();
}
