...
[Table("DB_OP_LISTRIK")]
public partial class DbOpListrik
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [Column("SUMBER", TypeName = "NUMBER")]
    public decimal Sumber { get; set; }

    [Column("SUMBER_NAMA")]
    [StringLength(50)]
    [Unicode(false)]
    public string SumberNama { get; set; } = null!;

    [Column("PERUNTUKAN", TypeName = "NUMBER")]
    public decimal Peruntukan { get; set; }
