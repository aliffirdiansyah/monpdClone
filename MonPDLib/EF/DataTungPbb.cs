...
public partial class DataTungPbb
{
    ...
    [StringLength(2)]
    [Unicode(false)]
    public string? SpptProp { get; set; }

    [Column("SPPT_KOTA")]
    [StringLength(2)]
    [Unicode(false)]
    public string? SpptKota { get; set; }

    [Column("SPPT_KEC")]
    [StringLength(3)]
    [Unicode(false)]
    public string? SpptKec { get; set; }

    [Column("SPPT_KEL")]
    [StringLength(3)]
    [Unicode(false)]
    public string? SpptKel { get; set; }

    [Column("SPPT_URUTBLK")]
    [StringLength(3)]
    [Unicode(false)]
    public string? SpptUrutblk { get; set; }

    [Column("SPPT_URUTOP")]
    [StringLength(4)]
    [Unicode(false)]
    public string? SpptUrutop { get; set; }

    [Column("SPPT_TANDA")]
    [StringLength(1)]
    [Unicode(false)]
    public string? SpptTanda { get; set; }

    [Column("TAHUN_PBB")]
    [StringLength(4)]
    [Unicode(false)]
    public string? TahunPbb { get; set; }
