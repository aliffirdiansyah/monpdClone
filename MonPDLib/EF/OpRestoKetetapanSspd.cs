...
[Table("OP_RESTO_KETETAPAN_SSPD")]
public partial class OpRestoKetetapanSspd
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpRestoKetetapanSspds")]
    public virtual OpRestoKetetapan OpRestoKetetapan { get; set; } = null!;
}
