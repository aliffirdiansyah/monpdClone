...
[Table("OP_RESTO_KETETAPAN")]
public partial class OpRestoKetetapan
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpRestoKetetapans")]
    ...
    [InverseProperty("OpRestoKetetapan")]
    public virtual ICollection<OpRestoKetetapanSspd> OpRestoKetetapanSspds { get; set; } = new List<OpRestoKetetapanSspd>();
}
