...
[Table("OP_PBB_KETETAPAN")]
public partial class OpPbbKetetapan
{
    [Key]
    [Column("NOP")]
    [StringLength(30)]
    ...
    [InverseProperty("OpPbbKetetapans")]
    public virtual MKategoriPajak Kategori { get; set; } = null!;

    [ForeignKey("Nop")]
    [InverseProperty("OpPbbKetetapans")]
    public virtual OpPbb NopNavigation { get; set; } = null!;

    [InverseProperty("OpPbbKetetapan")]
    public virtual ICollection<OpPbbKetetapanSspd> OpPbbKetetapanSspds { get; set; } = new List<OpPbbKetetapanSspd>();
}
