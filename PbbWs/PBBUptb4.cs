...
namespace PbbWs
{
    public class PBBUptb4 : BackgroundService
    {
        private bool isFirst = true;
        private readonly ILogger<PBBUptb4> _logger;
        private static int KDPajak = 9;
        private static int Uptb = 4;

        public PBBUptb4(ILogger<PBBUptb4> logger)
        {
            _logger = logger;
        }
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            _logger.LogInformation("PBBUptb4 running at: {time}", DateTimeOffset.Now);
