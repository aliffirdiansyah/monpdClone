...
namespace PbbWs
{
    public class PBBUptb1 : BackgroundService
    {
        private bool isFirst = true;
        private readonly ILogger<PBBUptb1> _logger;
        private static int KDPajak = 9;
        private static int Uptb = 1;

        public PBBUptb1(ILogger<PBBUptb1> logger)
        {
            _logger = logger;
        }
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            _logger.LogInformation("PBBUptb1 running at: {time}", DateTimeOffset.Now);
